...
```html
<script>
import {allDate} from './date.ts'
console.log(allDate.nowTime())
console.log(allDate.nowTimestyle())
console.log(allDate.TimeToDay())
console.log(allDate.timeToTime(new Date(), new Date()))
console.log(allDate.timeTodayTime())
console.log(allDate.TimeToDate())
console.log(allDate.TimetoDateDay())
console.log(allDate.timetoDateClock())
console.log(allDate.timetoDateSecond())
console.log(allDate.toDayStartAndEnd())
console.log(allDate.nextDay(4))
console.log(allDate.monthEndDay())
console.log(allDate.lastMonthDay(new Date()))
console.log(allDate.lastYearDay(new Date()))
</script>
```